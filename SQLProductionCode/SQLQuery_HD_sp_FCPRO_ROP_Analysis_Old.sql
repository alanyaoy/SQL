...
/****** Object:  StoredProcedure [JDE_DB_Alan].[sp_FCPro_ROP_Analysis]    Script Date: 8/04/2021 2:07:51 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
--CREATE PROCEDURE [JDE_DB_Alan].[sp_FCPro_Portfolio_Analysis] 

CREATE PROCEDURE [JDE_DB_Alan].[sp_FCPro_ROP_Analysis_Old] 
	   ...
	   with CalendarFrame as (
			...
			,flRop as ( 
						select  a.ShortItemNumber,a.ItemNumber,a.Sls_freq,a.SlsVol_TTL_12,a.ItemLvlFCVol_1To24,a.SlsVol_TTL_4,a.ItemLvlFCVol_TTL_4
							,a.StockingType,a.Pareto,a.SS_Adj,a.SS_Adj*a.Cost as SS_Adj_Dollars,a.LeadTime
							,a.ROP,a.ROP_EOQ
