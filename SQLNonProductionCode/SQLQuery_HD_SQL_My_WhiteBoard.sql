...
select * from JDE_DB_Alan.vw_Mast m where m.ItemNumber in ('24.7200.0000')
...
-------- 17/03/2020 ------------
select m.ItemNumber,m.PlannerNumber,m.Owner_
...
select * from JDE_DB_Alan.vw_Mast m where m.Family in ('VE1') order by m.ItemNumber
-------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------
select * from JDE_DB_Alan.vw_Mast m where m.ItemNumber in ('18.617.056')
...
select * from JDE_DB_Alan.vw_Mast m 
where m.ItemNumber in ('3400715320','3400350785')
