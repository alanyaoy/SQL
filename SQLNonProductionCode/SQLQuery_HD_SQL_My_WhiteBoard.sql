...
select * from JDE_DB_Alan.Master_ML345 m where m.ShortItemNumber in ('1028961')
...
select * from JDE_DB_Alan.OpenPO
 ...
 select * from JDE_DB_Alan.SlsHist_AWFHDMT_FCPro_upload h
 select * from JDE_DB_Alan.vw_Mast m where m.ItemNumber in ('s3000net5300n001','82.058.901','43.295.532','82.696.901','82.691.901')
...
exec JDE_DB_Alan.sp_FCPro_Portfolio_Analysis '4181301785','2019-02-01','2019-12-01'
...
exec JDE_DB_Alan.sp_FCPro_Portfolio_Analysis 'S3000NET5250N001','2019-03-01','2020-07-01'
...
exec JDE_DB_Alan.sp_FCPro_Portfolio_Analysis '2780229000','2019-02-01','2019-12-01'
