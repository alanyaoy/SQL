...
--BULK INSERT JDE_DB_Alan.SalesHistoryAWF
 ...
 -- bulk insert JDE_DB_Alan.FCPRO_MI_tmp
  ...
  from  'T:\Forecast Pro\Forecast Pro TRAC\Output\Hunter Douglas\FC_Pro_Fcst_upload_To_SQLSVR_CSV_Download_Template.csv'
   ...
   --   from 'C:\Users\yaoa\Alan_HD\Alan_Work\HD_DemandPlannning\FC_Change\HD_New_Product_Induction\Signature_Series_20037_CSV.csv'
	--  from 'C:\Users\yaoa\Alan_HD\Alan_Work\HD_DemandPlannning\FC_Change\HD_Market_Intelligence\Jde_FC_Downloaded_20037_BroomField_DA Review_CSV_.csv'
	 --   from 'C:\Users\yaoa\Alan_HD\Alan_Work\HD_DemandPlannning\FC_Change\HD_Market_Intelligence\Market_Intelligence_Upload_Template_CSV.csv'
	  --  from 'C:\Users\yaoa\Alan_HD\Alan_Work\HD_DemandPlannning\FC_Change\HD_New_Product_Induction\New_Product_Upload_Template_CSV.csv'
...
---=================================================================================================================
  ...
  --where cte.Date_Uploaded > '2018-07-02' and cte.Date_Uploaded < '2018-07-26 14:59:00'
  order by cte.Date_Uploaded asc

  select * from JDE_DB_Alan.FCPRO_Fcst_History fh where fh.ItemNumber in ('27.176.320')
  select distinct fh.DataType1 from JDE_DB_Alan.FCPRO_Fcst_History fh 
  ...
  select fh.ReportDate,count(fh.Value) from JDE_DB_Alan.FCPRO_Fcst_History fh where fh.ReportDate > dateadd(d,-3,getdate()) group by fh.ReportDate order by fh.ReportDate
   delete from JDE_DB_Alan.FCPRO_Fcst_History where ReportDate > '2018-05-05'
...
--- Signature New Product Post launch Analysis ---
 ...
 exec JDE_DB_Alan.sp_FCPro_Portfolio_Analysis '38.001.001,38.003.001,38.004.000,38.001.002,38.001.003,38.001.004,38.001.005,38.001.006,38.002.001,38.002.002,38.002.003,38.002.004,38.002.005,38.002.006,38.003.002,38.003.003,38.003.004,38.003.005,38.003.006','2018-08-01','2019-02-01'
  ...
  exec JDE_DB_Alan.sp_FCPro_Portfolio_Analysis '2801396351','2018-05-01','2018-12-01'
  exec JDE_DB_Alan.sp_FCPro_Portfolio_Analysis '2801396351','2019-07-01','2019-12-01'
...
exec JDE_DB_Alan.sp_MI_Raw_Mismatch_Combine null,'2018-12-02'
exec JDE_DB_Alan.sp_MI_Raw_Mismatch_Combine null,'2019-01-02'
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
